# -*- coding: utf-8 -*-
"""
04c_fetch_era5_openmeteo.py — گرفتن سری‌زمانی ERA5 برای هر ۸۰۴ نمونه
=====================================================================
...
DAYS_BEFORE = 7          # همان 04
N_HOURS = DAYS_BEFORE * 24   # 168
...
def main():
    ...
    print(f"\n💾 {OUT_NPZ}")
    print(f"💾 {MANIFEST}")
    print("\nقدم بعد: 06_validate_openmeteo.py — مقایسه با ۱۶۸ فایل ERA5-Land از CDS")
